...
namespace Svg.Basic_Shapes
{
    ...
    /// </summary>
    [SvgElement("image")]
    public sealed class SvgImage : SvgVisualElement
    {
        /// <inheritdoc />
        /// <summary>
        /// Initializes a new instance of the <see cref="T:Svg.Basic_Shapes.SvgImage" /> class.
        /// </summary>
		public SvgImage()
        {
		...
		public SvgUnit X
		{
			get => Attributes.GetAttribute<SvgUnit>("x");
		...
		public SvgUnit Y
		{
			get => Attributes.GetAttribute<SvgUnit>("y");
		...
		public string Href
		{
			get => Attributes.GetAttribute<string>("href");
        ...
        public override RectangleF Bounds =>
            TransformedBounds(new RectangleF(Location.ToDeviceValue(null, this),
        ...
        public object GetImage(string uriString)
        {
            ...
            try
            {
                ...
                {
                    var dataIdx = uriString.IndexOf(",", StringComparison.Ordinal) + 1;
        ...
        private static MemoryStream BufferToMemoryStream(Stream input)
        {
