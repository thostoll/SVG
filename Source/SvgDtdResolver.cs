...
namespace Svg
{
    internal class SvgDtdResolver : XmlUrlResolver
    {
        ...
        {
            return absoluteUri.ToString().IndexOf("svg", StringComparison.InvariantCultureIgnoreCase) > -1 
                ? Assembly.GetExecutingAssembly().GetManifestResourceStream("Svg.Resources.svg11.dtd") 
